...
const pages = [
    ...
    { name: 'Action', icon: <AddIcon />, genreId: '28' },
    { name: 'Comedy', icon: <StarIcon />, genreId: '35' },  
    { name: 'Crime', icon: <LocalMoviesIcon />, genreId: '80' },
    { name: 'Series', icon: <LiveTvIcon />, genreId: '10770' }
];
...
function ResponsiveAppBar() {
    ...
    const handleCloseNavMenu = (page) => {
        ...
        if (page.path) {
            navigate(page.path);
        } else if (page.genreId) {
            navigate(`/genre/${page.genreId}`);
        }
    };
